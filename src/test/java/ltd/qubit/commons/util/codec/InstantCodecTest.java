...
/**
 * Unit test of the {@link InstantCodec}.
 *
 * @author Haixing Hu
 */
public class InstantCodecTest {
  ...
  public void testEncode() throws Exception {
    final InstantCodec codec = new InstantCodec();
    ...
    assertEquals("2018-09-21T08:00:00Z", fixTrailingZeroMicroseconds(codec.encode(value)));
    ...
    assertEquals("2018-09-21T08:00:00.123Z", fixTrailingZeroMicroseconds(codec.encode(value2)));
