 ...
 *
 * <p>TODO: finish the test of remained functions.
 *
 * @author Haixing Hu
 */
public class InputOutputUtilsTest {
  ...
  public void testCharObject() throws IOException {
    ...
    final ByteArrayInputStream in = new ByteArrayInputStream(out.toByteArray());
    assertEquals('\0', InputUtils.readCharObject(in, true));
    assertEquals('x', InputUtils.readCharObject(in, true));
    assertEquals(null, InputUtils.readCharObject(in, true));
    assertEquals('y', InputUtils.readCharObject(in, true));
    try {
  ...
  public void testByteObject() throws IOException {
    ...
    final ByteArrayInputStream in = new ByteArrayInputStream(out.toByteArray());
    assertEquals((byte) 0, InputUtils.readByteObject(in, true));
    assertEquals((byte) 12, InputUtils.readByteObject(in, true));
    assertEquals((byte) -12, InputUtils.readByteObject(in, true));
    assertEquals(null, InputUtils.readByteObject(in, true));
    assertEquals(Byte.MIN_VALUE, InputUtils.readByteObject(in, true));
    assertEquals(Byte.MAX_VALUE, InputUtils.readByteObject(in, true));
    try {
  ...
  public void testShortObject() throws IOException {
    ...
    final ByteArrayInputStream in = new ByteArrayInputStream(out.toByteArray());
    assertEquals((short) 0, InputUtils.readShortObject(in, true));
    assertEquals((short) 1212, InputUtils.readShortObject(in, true));
    assertEquals((short) -1212,
        InputUtils.readShortObject(in, true));
  ...
  public void testVarShortObject() throws IOException {
    ...
    final ByteArrayInputStream in = new ByteArrayInputStream(out.toByteArray());
    assertEquals((short) 0, InputUtils.readVarShortObject(in, true));
    assertEquals((short) 1212,
        InputUtils.readVarShortObject(in, true));
    assertEquals(null, InputUtils.readShortObject(in, true));
    assertEquals(Short.MAX_VALUE,
        InputUtils.readVarShortObject(in, true));
    try {
  ...
  public void testIntObject() throws IOException {
    ...
    final ByteArrayInputStream in = new ByteArrayInputStream(out.toByteArray());
    assertEquals(0, InputUtils.readIntObject(in, true));
    assertEquals(1234567, InputUtils.readIntObject(in, true));
    assertEquals(-1234567, InputUtils.readIntObject(in, true));
    assertEquals(null, InputUtils.readIntObject(in, true));
    assertEquals(Integer.MIN_VALUE, InputUtils.readIntObject(in, true));
    assertEquals(Integer.MAX_VALUE, InputUtils.readIntObject(in, true));
    try {
    ...
    assertEquals(Integer.MAX_VALUE,
        InputUtils.readIntObject(in, true));
  }
  ...
  public void testVarIntObject() throws IOException {
    ...
    final ByteArrayInputStream in = new ByteArrayInputStream(out.toByteArray());
    assertEquals(0, InputUtils.readVarIntObject(in, true));
    assertEquals(1234567, InputUtils.readVarIntObject(in, true));
    assertEquals(null, InputUtils.readVarIntObject(in, true));
    assertEquals(Integer.MAX_VALUE,
        InputUtils.readVarIntObject(in, true));
    try {
  ...
  public void testLongObject() throws IOException {
    ...
    final ByteArrayInputStream in = new ByteArrayInputStream(out.toByteArray());
    assertEquals(0L, InputUtils.readLongObject(in, true));
    assertEquals(12345678901234567L,
        InputUtils.readLongObject(in, true));
    assertEquals(-12345678901234567L,
        InputUtils.readLongObject(in, true));
    assertEquals(null, InputUtils.readLongObject(in, true));
    assertEquals(Long.MIN_VALUE, InputUtils.readLongObject(in, true));
    assertEquals(Long.MAX_VALUE, InputUtils.readLongObject(in, true));
    try {
  ...
  public void testVarLongObject() throws IOException {
    ...
    final ByteArrayInputStream in = new ByteArrayInputStream(out.toByteArray());
    assertEquals(0L, InputUtils.readVarLongObject(in, true));
    assertEquals(12345678901234567L,
        InputUtils.readVarLongObject(in, true));
  ...
  public void testFloat() throws IOException {
    ...
    assertEquals(Float.NEGATIVE_INFINITY, InputUtils.readFloat(in),
        FLOAT_EPSILON);
    assertEquals(Float.POSITIVE_INFINITY, InputUtils.readFloat(in),
        FLOAT_EPSILON);
  }
  ...
  public void testFloatObject() throws IOException {
    ...
    assertEquals(1234.567f, InputUtils.readFloatObject(in, true),
        FLOAT_EPSILON);
    assertEquals(-1234.567f, InputUtils.readFloatObject(in, true),
        FLOAT_EPSILON);
    assertEquals(null, InputUtils.readFloatObject(in, true));
    assertEquals(Float.MIN_VALUE, InputUtils.readFloatObject(in, true),
        FLOAT_EPSILON);
    assertEquals(Float.MAX_VALUE, InputUtils.readFloatObject(in, true),
        FLOAT_EPSILON);
    assertEquals(Float.MIN_NORMAL, InputUtils.readFloatObject(in, true),
        FLOAT_EPSILON);
    assertEquals(Float.NaN, InputUtils.readFloatObject(in, true),
        FLOAT_EPSILON);
    assertEquals(Float.NEGATIVE_INFINITY, InputUtils.readFloatObject(in, true),
        FLOAT_EPSILON);
    assertEquals(Float.POSITIVE_INFINITY, InputUtils.readFloatObject(in, true),
        FLOAT_EPSILON);
    try {
  ...
  public void testDouble() throws IOException {
    ...
    assertEquals(Double.NEGATIVE_INFINITY, InputUtils.readDouble(in),
        FLOAT_EPSILON);
    assertEquals(Double.POSITIVE_INFINITY, InputUtils.readDouble(in),
        FLOAT_EPSILON);
  }
  ...
  public void testDoubleObject() throws IOException {
    ...
    assertEquals(1234.567, InputUtils.readDoubleObject(in, true),
        FLOAT_EPSILON);
    assertEquals(-1234.567, InputUtils.readDoubleObject(in, true),
        FLOAT_EPSILON);
    assertEquals(null, InputUtils.readDoubleObject(in, true));
    assertEquals(Double.MIN_VALUE, InputUtils.readDoubleObject(in, true),
        FLOAT_EPSILON);
    assertEquals(Double.MAX_VALUE, InputUtils.readDoubleObject(in, true),
        FLOAT_EPSILON);
    assertEquals(Double.MIN_NORMAL, InputUtils.readDoubleObject(in, true),
        FLOAT_EPSILON);
    assertEquals(Double.NaN, InputUtils.readDoubleObject(in, true),
        FLOAT_EPSILON);
    assertEquals(Double.NEGATIVE_INFINITY,
        InputUtils.readDoubleObject(in, true), FLOAT_EPSILON);
  ...
  public void testClass() throws IOException {
    ...
    assertEquals(AbstractSeekableInputStream.class,
        InputUtils.readClass(in, true));
  }

  @Test
  public void testEnum() throws IOException {
    final ByteArrayOutputStream out = new ByteArrayOutputStream();
    OutputUtils.writeEnum(out, Type.BOOL);
    ...
    final ByteArrayInputStream in = new ByteArrayInputStream(out.toByteArray());
    assertEquals(Type.BOOL, InputUtils.readEnum(Type.class, in, true));
    ...
    assertEquals(TimeUnit.MICROSECONDS,
        InputUtils.readEnum(TimeUnit.class, in, true));
    ...
    assertEquals(PatternType.GLOB,
        InputUtils.readEnum(PatternType.class, in, true));
