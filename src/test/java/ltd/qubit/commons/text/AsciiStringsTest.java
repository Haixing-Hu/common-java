...
import static ltd.qubit.commons.text.AsciiStringUtils.indexOfAny;
import static ltd.qubit.commons.text.AsciiStringUtils.indexOfAnyBut;
import static ltd.qubit.commons.text.AsciiStringUtils.indexOfAnyButIgnoreCase;
import static ltd.qubit.commons.text.AsciiStringUtils.indexOfAnyIgnoreCase;
...
public class AsciiStringsTest {
  ...
  public void testToStringByteArrayIntInt() {
    ...
    assertEquals("hello, \nworld!", AsciiStringUtils.toString(HELLO_WORLD,
        0, HELLO_WORLD.length));
    ...
    assertEquals("!", AsciiStringUtils.toString(HELLO_WORLD,
        HELLO_WORLD.length - 1, HELLO_WORLD.length));
  }
  ...
  /**
   * Test method for {@link AsciiStringUtils#indexOfIgnoreCase(byte[], int, int,
   * byte)}.
   */
  @Test
  ...
  /**
   * Test method for {@link AsciiStringUtils#indexOfAny(byte[], int, int,
   * byte[])}.
   */
  @Test
  public void testIndexOfAny() {
    assertEquals(-1, indexOfAny(EMPTY, 0, 0, (byte) 0));
    assertEquals(-1, indexOfAny(EMPTY, 0, 0, (byte) ' '));
    assertEquals(-1, indexOfAny(EMPTY, 0, 0, (byte) 0, (byte) 0));
    assertEquals(-1, indexOfAny(EMPTY, 0, 0, (byte) ' ', (byte) ' '));
    assertEquals(-1, indexOfAny(HELLO_WORLD, 0, 0, (byte) ' '));
    assertEquals(-1, indexOfAny(HELLO_WORLD, 0, 0, (byte) ' ', (byte) ' '));
    assertEquals(-1, indexOfAny(HELLO_WORLD, 0, 0, (byte) 'o', (byte) 'o'));

    assertEquals(0, indexOfAny(HELLO_WORLD, 0, HELLO_WORLD.length, (byte) 'o', (byte) 'h'));
    assertEquals(1, indexOfAny(HELLO_WORLD, 0, HELLO_WORLD.length, (byte) 'o', (byte) 'e'));
    assertEquals(2, indexOfAny(HELLO_WORLD, 0, HELLO_WORLD.length, (byte) 'o', (byte) 'l'));
    assertEquals(5, indexOfAny(HELLO_WORLD, 5, HELLO_WORLD.length, (byte) 'd', (byte) ','));
    assertEquals(12, indexOfAny(HELLO_WORLD, 6, HELLO_WORLD.length, (byte) 'd', (byte) ','));

    assertEquals(-1, indexOfAny(HELLO_WORLD, 4, 3, (byte) 'o', (byte) '!'));
    assertEquals(-1, indexOfAny(HELLO_WORLD, 4, 4, (byte) 'o', (byte) '!'));
    assertEquals(4, indexOfAny(HELLO_WORLD, 4, 5, (byte) 'o', (byte) '!'));

    assertEquals(-1, indexOfAny(HELLO_WORLD, 0, HELLO_WORLD.length, (byte) 'O', (byte) 'E'));
    assertEquals(1, indexOfAny(HELLO_UPPERCASE, 0, HELLO_UPPERCASE.length, (byte) 'O', (byte) 'E'));
  ...
  /**
   * Test method for {@link AsciiStringUtils#indexOfAnyIgnoreCase(byte[], int,
   * int, byte[])}.
   */
  @Test
  public void testIndexOfAnyIgnoreCase() {
    assertEquals(-1, indexOfAnyIgnoreCase(EMPTY, 0, 0, (byte) 0));
    assertEquals(-1, indexOfAnyIgnoreCase(EMPTY, 0, 0, (byte) ' '));
    assertEquals(-1, indexOfAnyIgnoreCase(EMPTY, 0, 0, (byte) 0, (byte) 0));
    assertEquals(-1, indexOfAnyIgnoreCase(EMPTY, 0, 0, (byte) ' ', (byte) ' '));
    assertEquals(-1, indexOfAnyIgnoreCase(HELLO_WORLD, 0, 0, (byte) ' '));
    assertEquals(-1, indexOfAnyIgnoreCase(HELLO_WORLD, 0, 0, (byte) ' ', (byte) ' '));
    assertEquals(-1, indexOfAnyIgnoreCase(HELLO_WORLD, 0, 0, (byte) 'o', (byte) 'o'));
    ...
    assertEquals(1, indexOfAnyIgnoreCase(HELLO_WORLD, 0, HELLO_WORLD.length,
        (byte) 'O', (byte) 'E'));
    assertEquals(1,
        indexOfAnyIgnoreCase(HELLO_UPPERCASE, 0, HELLO_UPPERCASE.length,
            (byte) 'O', (byte) 'E'));
    assertEquals(2,
        indexOfAnyIgnoreCase(HELLO_UPPERCASE, 0, HELLO_UPPERCASE.length,
            (byte) 'o', (byte) 'l'));
  ...
  /**
   * Test method for {@link AsciiStringUtils#indexOfAnyBut(byte[], int, int,
   * byte[])}.
   */
  @Test
  ...
  /**
   * Test method for {@link AsciiStringUtils#indexOfAnyButIgnoreCase(byte[],
   * int, int, byte[])}.
   */
  @Test
  public void testIndexOfAnyButIgnoreCase() {
    ...
    assertEquals(5, indexOfAnyButIgnoreCase(HELLO_WORLD, 0, HELLO_WORLD.length,
        (byte) 'o', (byte) 'h', (byte) 'e', (byte) 'L', (byte) '\n'));
    assertEquals(-1,
        indexOfAnyButIgnoreCase(HELLO_UPPERCASE, 0, HELLO_UPPERCASE.length,
            (byte) 'o', (byte) 'H', (byte) 'E', (byte) 'l', (byte) '\n'));
    assertEquals(-1,
        indexOfAnyButIgnoreCase(HELLO_UPPERCASE, 0, HELLO_UPPERCASE.length,
            (byte) 'H', (byte) 'E', (byte) 'L', (byte) 'O'));
  ...
  /**
   * Test method for {@link AsciiStringUtils#indexOfWhitespace(byte[], int,
   * int)}.
   */
  @Test
  public void testIndexOfWhitespace() {
    ...
    assertEquals(0,
        indexOfWhitespace(ALL_WHITE_SPACE, 0, ALL_WHITE_SPACE.length));
    assertEquals(1,
        indexOfWhitespace(ALL_WHITE_SPACE, 1, ALL_WHITE_SPACE.length));
    assertEquals(2,
        indexOfWhitespace(ALL_WHITE_SPACE, 2, ALL_WHITE_SPACE.length));
    assertEquals(3,
        indexOfWhitespace(ALL_WHITE_SPACE, 3, ALL_WHITE_SPACE.length));
    assertEquals(4,
        indexOfWhitespace(ALL_WHITE_SPACE, 4, ALL_WHITE_SPACE.length));
    assertEquals(5,
        indexOfWhitespace(ALL_WHITE_SPACE, 5, ALL_WHITE_SPACE.length));
  }
  ...
  /**
   * Test method for
   * {@link AsciiStringUtils#lastIndexOfIgnoreCase(byte[], int, int, byte[], int, int)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link AsciiStringUtils#startsWithIgnoreCase(byte[], int, int, byte[], int, int)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link AsciiStringUtils#endsWithIgnoreCase(byte[], int, int, byte[], int, int)}.
   */
  @Test
