...
public class ParseUtilsTest {
  ...
  public final void testSkipBlanks() {
    ...
    assertEquals(ErrorCode.NONE, pos.getErrorCode());
  ...
  public final void testGetSpecialRadixInt() {
    ...
    value = ParseUtils.getSpecialRadixInt(pos, str, str.length(), + 1, 2,
        IntUtils.UNSIGNED_MAX, Integer.MAX_VALUE, false, ',');
    assertEquals(0, value);
    assertEquals(0, pos.getIndex());
    assertEquals(ErrorCode.EMPTY_VALUE, pos.getErrorCode());
    ...
    pos.setIndex(0);
    value = ParseUtils.getSpecialRadixInt(pos, str, str.length(), + 1, 2,
        ByteUtils.UNSIGNED_MAX, Integer.MAX_VALUE, false, ',');
    assertEquals(123, value);
    ...
    pos.setIndex(0);
    value = ParseUtils.getSpecialRadixInt(pos, str, str.length(), + 1, 2,
        ShortUtils.UNSIGNED_MAX, Integer.MAX_VALUE, false, ',');
    assertEquals(12345, value);
    ...
    assertEquals(ByteUtils.UNSIGNED_MAX, value);
    assertEquals(9, pos.getIndex());
    assertEquals(ErrorCode.NUMBER_OVERFLOW, pos.getErrorCode());
  ...
  public final void testGetDecimalInt() {
    ...
    pos.setIndex(0);
    value = ParseUtils.getDecimalInt(pos, str, str.length(), + 1,
        Byte.MAX_VALUE, Integer.MAX_VALUE, false, ',');
    assertEquals(123, value);
    assertEquals(3, pos.getIndex());
    assertEquals(ErrorCode.NONE, pos.getErrorCode());
    assertEquals(- 1, pos.getErrorIndex());
    ...
    pos.setIndex(0);
    value = ParseUtils.getDecimalInt(pos, str, str.length(), + 1,
        Short.MAX_VALUE, Integer.MAX_VALUE, false, ',');
    assertEquals(12345, value);
    assertEquals(5, pos.getIndex());
    assertEquals(ErrorCode.NONE, pos.getErrorCode());
    assertEquals(- 1, pos.getErrorIndex());
