...
import static ltd.qubit.commons.test.XmlUnitUtils.assertXPathAbsent;
...
public abstract class JacksonXmlTestUtils {
  ...
  public static <T> void assertXmlSerializeEquals(final Class<T> cls,
      final T object, final String expectedXml) throws Exception {
    assertXmlSerializeEquals(new CustomizedXmlMapper(), cls, object, expectedXml);
  }
  ...
  public static <T> void assertXmlDeserializeEquals(final Class<T> cls,
      final String xml, final T expected) throws Exception {
    assertXmlDeserializeEquals(new CustomizedXmlMapper(), cls, xml, expected);
  }

  public static <T> void assertXmlDeserializeEquals(final XmlMapper mapper,
      final Class<T> cls, final String xml, final T expected)
      throws Exception {
