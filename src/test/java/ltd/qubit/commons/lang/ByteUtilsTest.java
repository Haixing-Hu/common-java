...
public class ByteUtilsTest {
  ...
  @Test
  public void testToFloat_Byte() {
    assertEquals(FloatUtils.DEFAULT, ByteUtils.toFloat(null),
        FloatUtils.EPSILON);
  ...
  @Test
  public void testToDouble_Byte() {
    assertEquals(DoubleUtils.DEFAULT, ByteUtils.toDouble(null),
        DoubleUtils.EPSILON);
  ...
  public void testToBigDecimal_Byte_BigDecimal() {
    ...
    for (int i = Byte.MIN_VALUE; i <= Byte.MAX_VALUE; ++i) {
      assertEquals(BigDecimal.valueOf(i),
          ByteUtils.toBigDecimal(null, BigDecimal.valueOf(i)));
    }
    ...
    for (int i = Byte.MIN_VALUE; i <= Byte.MAX_VALUE; ++i) {
      ...
      for (int j = Byte.MIN_VALUE; j <= Byte.MAX_VALUE; ++j) {
        assertEquals(BigDecimal.valueOf(i),
            ByteUtils.toBigDecimal(x, BigDecimal.valueOf(j)));
      }
    }
  }
