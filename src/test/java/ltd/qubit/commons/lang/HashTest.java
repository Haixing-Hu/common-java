...
public class HashTest {
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        for (int k = 0; k < argarray.length; ++k) {
          ...
          assertEquals(out, Hash.combine(intarray1[i], intarray2[j], argarray[k]));
        }
      }
    }
  }
  ...
  public void testObject() {
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        ...
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], (Object) argarray1));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        ...
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], (Object) argarray2));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        ...
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], (Object) argarray3));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        ...
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], (Object) argarray4));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        ...
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], (Object) argarray5));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        ...
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], (Object) argarray6));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        ...
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], (Object) argarray7));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        ...
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], (Object) argarray8));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = 0;
        for (int k = 0; k < argarray1.length; ++k) {
          out = Hash.combine(intarray1[i], intarray2[j], argarray9);
        }
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], (Object) argarray9));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        ...
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], (Object) arg10));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i] * intarray2[j];
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], arg11));
      }
    }
  }
  ...
  public void testObjectArray() {
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        for (int k = 0; k < argarray1.length; ++k) {
          if (k == 0) {
            out = Hash.combine(intarray1[i], intarray2[j], argarray1[k]);
          } else {
            out = Hash.combine(out, intarray2[j], argarray1[k]);
          }
        }
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], argarray1));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        for (int k = 0; k < argarray2.length; ++k) {
          if (k == 0) {
            out = Hash.combine(intarray1[i], intarray2[j], argarray2[k]);
          } else {
            out = Hash.combine(out, intarray2[j], argarray2[k]);
          }
        }
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], argarray2));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        for (int k = 0; k < argarray3.length; ++k) {
          if (k == 0) {
            out = Hash.combine(intarray1[i], intarray2[j], argarray3[k]);
          } else {
            out = Hash.combine(out, intarray2[j], argarray3[k]);
          }
        }
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], argarray3));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        for (int k = 0; k < argarray4.length; ++k) {
          if (k == 0) {
            out = Hash.combine(intarray1[i], intarray2[j], argarray4[k]);
          } else {
            out = Hash.combine(out, intarray2[j], argarray4[k]);
          }
        }
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], argarray4));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        for (int k = 0; k < argarray5.length; ++k) {
          if (k == 0) {
            out = Hash.combine(intarray1[i], intarray2[j], argarray5[k]);
          } else {
            out = Hash.combine(out, intarray2[j], argarray5[k]);
          }
        }
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], argarray5));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        for (int k = 0; k < argarray6.length; ++k) {
          if (k == 0) {
            out = Hash.combine(intarray1[i], intarray2[j], argarray6[k]);
          } else {
            out = Hash.combine(out, intarray2[j], argarray6[k]);
          }
        }
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], argarray6));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        for (int k = 0; k < argarray7.length; ++k) {
          if (k == 0) {
            out = Hash.combine(intarray1[i], intarray2[j], argarray7[k]);
          } else {
            out = Hash.combine(out, intarray2[j], argarray7[k]);
          }
        }
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], argarray7));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        for (int k = 0; k < argarray8.length; ++k) {
          if (k == 0) {
            out = Hash.combine(intarray1[i], intarray2[j], argarray8[k]);
          } else {
            out = Hash.combine(out, intarray2[j], argarray8[k]);
          }
        }
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], argarray8));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        for (int k = 0; k < argarray9.length; ++k) {
          if (k == 0) {
            out = Hash.combine(intarray1[i], intarray2[j], argarray9[k]);
          } else {
            out = Hash.combine(out, intarray2[j], argarray9[k]);
          }
        }
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], argarray9));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i] * intarray2[j];
        assertEquals(out,
            Hash.combine(intarray1[i], intarray2[j], argarray10));
      }
    }
  ...
  public void testCollection() {
    ...
    final ArrayList<?> argarray0 = null;

    final ArrayList<Boolean> argarray1 = new ArrayList<>();
    argarray1.add(true);
    argarray1.add(false);
    argarray1.add(true);

    final ArrayList<Character> argarray2 = new ArrayList<>();
    ...
    final ArrayList<Byte> argarray3 = new ArrayList<>();
    ...
    final ArrayList<Short> argarray4 = new ArrayList<>();
    ...
    final ArrayList<Integer> argarray5 = new ArrayList<>();
    argarray5.add(0);
    argarray5.add(-1);
    argarray5.add(1);
    argarray5.add((Integer.MIN_VALUE / 2));
    argarray5.add(Integer.MIN_VALUE);
    argarray5.add((Integer.MAX_VALUE / 2));
    argarray5.add(Integer.MAX_VALUE);

    final ArrayList<Long> argarray6 = new ArrayList<>();
    argarray6.add((long) 0);
    argarray6.add((long) -1);
    argarray6.add((long) 1);
    argarray6.add((Long.MIN_VALUE / 2));
    argarray6.add(Long.MIN_VALUE);
    argarray6.add((Long.MAX_VALUE / 2));
    argarray6.add(Long.MAX_VALUE);

    final ArrayList<Float> argarray7 = new ArrayList<>();
    argarray7.add((float) 0);
    argarray7.add((float) -1);
    argarray7.add((float) 1);
    argarray7.add((Float.MIN_VALUE / 2));
    argarray7.add(Float.MIN_VALUE);
    argarray7.add((Float.MAX_VALUE / 2));
    argarray7.add(Float.MAX_VALUE);

    final ArrayList<Double> argarray8 = new ArrayList<>();
    argarray8.add((double) 0);
    argarray8.add((double) -1);
    argarray8.add((double) 1);
    argarray8.add((Double.MIN_VALUE / 2));
    argarray8.add(Double.MIN_VALUE);
    argarray8.add((Double.MAX_VALUE / 2));
    argarray8.add(Double.MAX_VALUE);

    final ArrayList<Object> argarray9 = new ArrayList<>();
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i] * intarray2[j];
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], argarray0));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i];
        for (final Boolean val : argarray1) {
          out = out * intarray2[j] + val.hashCode();
        }
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], argarray1));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i];
        for (final Character val : argarray2) {
          out = out * intarray2[j] + val.hashCode();
        }
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], argarray2));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i];
        for (final Byte val : argarray3) {
          out = out * intarray2[j] + val.hashCode();
        }
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], argarray3));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i];
        for (final Short val : argarray4) {
          out = out * intarray2[j] + val.hashCode();
        }
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], argarray4));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i];
        for (final Integer val : argarray5) {
          out = out * intarray2[j] + val.hashCode();
        }
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], argarray5));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i];
        for (final Long val : argarray6) {
          out = out * intarray2[j] + val.hashCode();
        }
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], argarray6));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i];
        for (final Float val : argarray7) {
          out = out * intarray2[j] + val.hashCode();
        }
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], argarray7));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i];
        for (final Double val : argarray8) {
          out = out * intarray2[j] + val.hashCode();
        }
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], argarray8));
      }
    }
    ...
    for (int i = 0; i < intarray1.length; ++i) {
      for (int j = 0; j < intarray2.length; ++j) {
        out = intarray1[i];
        for (final Object val : argarray9) {
          out = Hash.combine(out, intarray2[j], val);
        }
        assertEquals(out, Hash.combine(intarray1[i], intarray2[j], argarray9));
      }
    }
  }
