...
public class FloatUtilsTest {
  ...
  private static final float[] AREA = {Float.MIN_VALUE, Float.MIN_VALUE / 2, -1,
      0, 1, Float.MAX_VALUE, Float.MAX_VALUE};

  @Test
  public void testToPrimitive_Float() {
    assertEquals(FloatUtils.DEFAULT, FloatUtils.toPrimitive(null),
        FloatUtils.EPSILON);
  ...
  public void testToPrimitive_Float_float() {
    for (final float element : AREA) {
      assertEquals(element, FloatUtils.toPrimitive(null, element),
          FloatUtils.EPSILON);
    }
  ...
  public void testToChar_Float_char() {
    final char[] a = {(char) Integer.MIN_VALUE, (char) Integer.MIN_VALUE / 2,
        (char) 0,
  ...
  public void testToCharObject_Float_Character() {
    final Character[] a = {(char) Integer.MIN_VALUE,
        (char) Integer.MIN_VALUE / 2, (char) 0,
        (char) 1, (char) Integer.MAX_VALUE / 2, (char) Integer.MAX_VALUE};
  ...
  @Test
  public void testToDouble_Float() {
    assertEquals(DoubleUtils.DEFAULT, FloatUtils.toDouble(null),
        DoubleUtils.EPSILON);
  ...
  public void testToString_Float_String() {
    ...
    System.err.printf("JAVA_VERSION = %s\n", SystemUtils.JAVA_VERSION);
    System.err.printf("JAVA_VERSION_TRIMMED = %s\n",
        SystemUtils.JAVA_VERSION_TRIMMED);
    System.err
        .printf("JAVA_VERSION_FLOAT = %f\n", SystemUtils.JAVA_VERSION_FLOAT);
    ...
    if (SystemUtils.JAVA_VERSION_FLOAT >= 7.0f) {
  ...
  public void testToDate_Float_Date() {
    final Date[] a = {new Date(Long.MIN_VALUE), new Date(Long.MIN_VALUE / 2),
        new Date(-1),
        new Date(0), new Date(1), new Date(Long.MAX_VALUE / 2),
  ...
  public void testToByteArray_float() {
    for (final float element : AREA) {
      assertArrayEquals(
          IntUtils.toByteArray(Float.floatToIntBits(element), DEFAULT_BYTE_ORDER),
  ...
  public void testToByteArray_float_ByteOrder() {
    for (final float element : AREA) {
      assertArrayEquals(
          IntUtils.toByteArray(Float.floatToIntBits(element), BIG_ENDIAN),
          FloatUtils.toByteArray(element, BIG_ENDIAN));
      assertArrayEquals(IntUtils
              .toByteArray(Float.floatToIntBits(element), LITTLE_ENDIAN),
          FloatUtils.toByteArray(element, LITTLE_ENDIAN));
    }
  }
  ...
  public void testToByteArray_Float() {
    for (final float x : AREA) {
      assertArrayEquals(
          IntUtils.toByteArray(Float.floatToIntBits(x), DEFAULT_BYTE_ORDER),
  ...
  public void testToByteArray_Float_ByteOrder() {
    for (final float x : AREA) {
      assertArrayEquals(
          IntUtils.toByteArray(Float.floatToIntBits(x), BIG_ENDIAN),
          FloatUtils.toByteArray(x, BIG_ENDIAN));
      assertArrayEquals(
          IntUtils.toByteArray(Float.floatToIntBits(x), LITTLE_ENDIAN),
          FloatUtils.toByteArray(x, LITTLE_ENDIAN));
    }
  }
  ...
  public void testToByteArray_Float_ByteArray_ByteOrder() {
    for (final float x : AREA) {
      ...
      assertArrayEquals(
          IntUtils.toByteArray(Float.floatToIntBits(x), BIG_ENDIAN),
          FloatUtils.toByteArray(x, y, BIG_ENDIAN));
      assertArrayEquals(IntUtils
              .toByteArray(Float.floatToIntBits(x), LITTLE_ENDIAN),
          FloatUtils.toByteArray(x, y, LITTLE_ENDIAN));
    }
  }
