...
public class LongUtilsTest {
  ...
  private static final long[] AREA = {Long.MIN_VALUE, Long.MIN_VALUE / 2,
      (long) -1, (long) 0, (long) 1, Long.MAX_VALUE / 2, Long.MAX_VALUE};
  ...
  public void testToBooleanObject_long() {
    for (int i = 0; i < AREA.length; ++i) {
      assertEquals(Boolean.valueOf(AREA[i] != 0),
          LongUtils.toBooleanObject(AREA[i]));
    }
  }
  ...
  public void testToShort_Long_short() {
    final short[] a = {Short.MIN_VALUE, Short.MIN_VALUE / 2, (short) -1, (short) 0,
        (short) 1,
  ...
  public void testToFloat_long() {
    for (int i = 0; i < AREA.length; ++i) {
      assertEquals((float) AREA[i], LongUtils.toFloat(AREA[i]),
          FloatUtils.EPSILON);
    }
  }
  ...
  @Test
  public void testToFloat_Long() {
    assertEquals(FloatUtils.DEFAULT, LongUtils.toFloat(null),
        FloatUtils.EPSILON);
  ...
  public void testToFloat_Long_float() {
    ...
    for (int i = 0; i < AREA.length; ++i) {
      final Long x = AREA[i];
      for (int j = 0; j < a.length; ++j) {
        assertEquals((float) AREA[i], LongUtils.toFloat(x, a[j]),
            FloatUtils.EPSILON);
      }
    }
  }
  ...
  public void testToDouble_long() {
    for (int i = 0; i < AREA.length; ++i) {
      assertEquals((double) AREA[i], LongUtils.toDouble(AREA[i]),
          DoubleUtils.EPSILON);
    }
  }
  ...
  @Test
  public void testToDouble_Long() {
    assertEquals(DoubleUtils.DEFAULT, LongUtils.toDouble(null),
        DoubleUtils.EPSILON);

    for (int i = 0; i < AREA.length; ++i) {
      final Long x = AREA[i];
      assertEquals((double) AREA[i], LongUtils.toDouble(x),
          DoubleUtils.EPSILON);
    }
  }
  ...
  public void testToDouble_Long_double() {
    ...
    for (int i = 0; i < AREA.length; ++i) {
      final Long x = AREA[i];
      for (int j = 0; j < a.length; ++j) {
        assertEquals((double) AREA[i], LongUtils.toDouble(x, a[j]),
            DoubleUtils.EPSILON);
      }
    }
  }
  ...
  public void testToHexString_long() {
    assertEquals("0x0000000000000000",
        LongUtils.toHexString(0x0000000000000000L));
    assertEquals("0x0000000A0000000A",
        LongUtils.toHexString(0x0000000A0000000AL));
    assertEquals("0x0000AAAA0000AAAA",
        LongUtils.toHexString(0x0000AAAA0000AAAAL));
    assertEquals("0x0000FFFF0000FFFF",
        LongUtils.toHexString(0x0000FFFF0000FFFFL));
    assertEquals("0xAAAAAAAAAAAAAAAA",
        LongUtils.toHexString(0xAAAAAAAAAAAAAAAAL));
    assertEquals("0xFFFFFFFFFFFFFFFF",
        LongUtils.toHexString(0xFFFFFFFFFFFFFFFFL));
  }
  ...
  public void testToByteArray_long_ByteOrder() {
    ...
    assertArrayEquals(xa,
        LongUtils.toByteArray(0x0000000000000000L, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xa,
        LongUtils.toByteArray(0x0000000000000000L, ByteOrder.BIG_ENDIAN));

    final byte[] xb = {(byte) 0xAB, (byte) 0x00, (byte) 0xAB, (byte) 0x00,
        (byte) 0xAB, (byte) 0x00, (byte) 0xAB, (byte) 0x00};
    assertArrayEquals(xb,
        LongUtils.toByteArray(0x00AB00AB00AB00ABL, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xb,
        LongUtils.toByteArray(0xAB00AB00AB00AB00L, ByteOrder.BIG_ENDIAN));

    final byte[] xc = {(byte) 0xAB, (byte) 0xAB, (byte) 0xAB, (byte) 0xAB,
        (byte) 0xAB, (byte) 0xAB, (byte) 0xAB, (byte) 0xAB};
    assertArrayEquals(xc,
        LongUtils.toByteArray(0xABABABABABABABABL, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xc,
        LongUtils.toByteArray(0xABABABABABABABABL, ByteOrder.BIG_ENDIAN));

    final byte[] xd = {(byte) 0xFF, (byte) 0x00, (byte) 0xFF, (byte) 0x00,
        (byte) 0xFF, (byte) 0x00, (byte) 0xFF, (byte) 0x00};
    assertArrayEquals(xd,
        LongUtils.toByteArray(0x00FF00FF00FF00FFL, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xd,
        LongUtils.toByteArray(0xFF00FF00FF00FF00L, ByteOrder.BIG_ENDIAN));

    final byte[] xe = {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF,
        (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF};
    assertArrayEquals(xe,
        LongUtils.toByteArray(0xFFFFFFFFFFFFFFFFL, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xe,
        LongUtils.toByteArray(0xFFFFFFFFFFFFFFFFL, ByteOrder.BIG_ENDIAN));

    final byte[] xf = {(byte) 0xBB, (byte) 0xAA, (byte) 0xBB, (byte) 0xAA,
        (byte) 0xBB, (byte) 0xAA, (byte) 0xBB, (byte) 0xAA};
    assertArrayEquals(xf,
        LongUtils.toByteArray(0xAABBAABBAABBAABBL, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xf,
        LongUtils.toByteArray(0xBBAABBAABBAABBAAL, ByteOrder.BIG_ENDIAN));
  ...
  public void testToByteArray_Long_ByteOrder() {
    ...
    assertArrayEquals(null,
        LongUtils.toByteArray(null, ByteOrder.LITTLE_ENDIAN));
  ...
  public void testToByteArray_Long_ByteArray_ByteOrder() {
    ...
    assertArrayEquals(xa,
        LongUtils.toByteArray(ya, za, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xa, LongUtils.toByteArray(ya, x, ByteOrder.BIG_ENDIAN));
    assertArrayEquals(xa,
        LongUtils.toByteArray(ya, x, ByteOrder.LITTLE_ENDIAN));
    final byte[] xb = {(byte) 0xAB, (byte) 0x00, (byte) 0xAB, (byte) 0x00,
        (byte) 0xAB, (byte) 0x00, (byte) 0xAB, (byte) 0x00};
    ...
    assertArrayEquals(xb,
        LongUtils.toByteArray(yb2, zb, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xb, LongUtils.toByteArray(yb1, x, ByteOrder.BIG_ENDIAN));
    assertArrayEquals(xb,
        LongUtils.toByteArray(yb2, x, ByteOrder.LITTLE_ENDIAN));
    final byte[] xc = {(byte) 0xAB, (byte) 0xAB, (byte) 0xAB, (byte) 0xAB,
        (byte) 0xAB, (byte) 0xAB, (byte) 0xAB, (byte) 0xAB};
    final Long yc = 0xABABABABABABABABL;
    final byte[] zc = {};
    ...
    assertArrayEquals(xc,
        LongUtils.toByteArray(yc, zc, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xc, LongUtils.toByteArray(yc, x, ByteOrder.BIG_ENDIAN));
    assertArrayEquals(xc,
        LongUtils.toByteArray(yc, x, ByteOrder.LITTLE_ENDIAN));
    final byte[] xd = {(byte) 0xFF, (byte) 0x00, (byte) 0xFF, (byte) 0x00,
        (byte) 0xFF, (byte) 0x00, (byte) 0xFF, (byte) 0x00};
    ...
    assertArrayEquals(xd,
        LongUtils.toByteArray(yd2, zd, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xd, LongUtils.toByteArray(yd1, x, ByteOrder.BIG_ENDIAN));
    assertArrayEquals(xd,
        LongUtils.toByteArray(yd2, x, ByteOrder.LITTLE_ENDIAN));
    final byte[] xe = {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF,
        (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF};
    final Long ye = 0xFFFFFFFFFFFFFFFFL;
    final byte[] ze = {};
    ...
    assertArrayEquals(xe,
        LongUtils.toByteArray(ye, ze, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xe, LongUtils.toByteArray(ye, x, ByteOrder.BIG_ENDIAN));
    assertArrayEquals(xe,
        LongUtils.toByteArray(ye, x, ByteOrder.LITTLE_ENDIAN));
    final byte[] xf = {(byte) 0xBB, (byte) 0xAA, (byte) 0xBB, (byte) 0xAA,
        (byte) 0xBB, (byte) 0xAA, (byte) 0xBB, (byte) 0xAA};
    ...
    assertArrayEquals(xf,
        LongUtils.toByteArray(yf2, zf, ByteOrder.LITTLE_ENDIAN));
    assertArrayEquals(xf, LongUtils.toByteArray(yf1, x, ByteOrder.BIG_ENDIAN));
    assertArrayEquals(xf,
        LongUtils.toByteArray(yf2, x, ByteOrder.LITTLE_ENDIAN));
  }
