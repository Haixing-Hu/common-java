...
public class StringUtilsIsTest {
  ...
  public void testIsBlank() {
    ...
    assertEquals(true,
        StringUtils.isBlank(StringUtilsTest.NON_WHITE_SPACE_BUT_BLANK));
  ...
  public void testIsLetter() {
    ...
    assertEquals(false,
        StringUtils.isLetter("hkHKHik6iUGHKJgU7tUJgKJGI87GIkug"));
  ...
  public void testIsLetterDigit() {
    ...
    assertEquals(true, StringUtils.isLetterDigit("A"));
    assertEquals(true,
        StringUtils.isLetterDigit("kgKgKgKgkgkGkjkjlJlOKLgHdGdHgl"));
    assertEquals(false, StringUtils.isLetterDigit("ham kso"));
    assertEquals(true, StringUtils.isLetterDigit("1"));
    assertEquals(true,
        StringUtils.isLetterDigit("hkHKHik6iUGHKJgU7tUJgKJGI87GIkug"));
  ...
  public void testIsWhiteSpace() {
    ...
    assertEquals(false,
        StringUtils.isWhitespace(StringUtilsTest.NON_WHITE_SPACE_BUT_BLANK));
  }
  ...
  public void testIsLetterSpace() {
    ...
    assertEquals(true, StringUtils.isLetterSpace("A"));
    assertEquals(true,
        StringUtils.isLetterSpace("kgKgKgKgkgkGkjkjlJlOKLgHdGdHgl"));
    assertEquals(true, StringUtils.isLetterSpace("ham kso"));
    assertEquals(false, StringUtils.isLetterSpace("1"));
    assertEquals(false,
        StringUtils.isLetterSpace("hkHKHik6iUGHKJgU7tUJgKJGI87GIkug"));
  ...
  public void testIsLetterDigitSpace() {
    ...
    assertEquals(true, StringUtils.isLetterDigitSpace("A"));
    assertEquals(true,
        StringUtils.isLetterDigitSpace("kgKgKgKgkgkGkjkjlJlOKLgHdGdHgl"));
    assertEquals(true, StringUtils.isLetterDigitSpace("ham kso"));
    assertEquals(true, StringUtils.isLetterDigitSpace("1"));
    assertEquals(true,
        StringUtils.isLetterDigitSpace("hkHKHik6iUGHKJgU7tUJgKJGI87GIkug"));
  ...
  public void testIsAscii_String() {
    ...
    assertEquals(true,
        StringUtils.isAscii("hkHK=Hik6i?UGH_KJgU7.tUJgKJ*GI87GI,kug"));
    assertEquals(true, StringUtils.isAscii("\u0020"));
    assertEquals(true, StringUtils.isAscii("\u0021"));
    assertEquals(true, StringUtils.isAscii("\u007e"));
    assertEquals(true, StringUtils.isAscii("\u007f"));
  ...
  public void testIsDigit() {
    ...
    assertEquals(false,
        StringUtils.isDigit("hkHKHik6iUGHKJgU7tUJgKJGI87GIkug"));
  ...
  public void testIsDigitSpace() {
    ...
    assertEquals(false, StringUtils.isDigitSpace("A"));
    assertEquals(false,
        StringUtils.isDigitSpace("kgKgKgKgkgkGkjkjlJlOKLgHdGdHgl"));
    ...
    assertEquals(false,
        StringUtils.isDigitSpace("hkHKHik6iUGHKJgU7tUJgKJGI87GIkug"));
