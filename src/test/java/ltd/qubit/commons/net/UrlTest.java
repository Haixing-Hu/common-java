...
public class UrlTest {
  ...
  public void testUrl() throws MalformedURLException {
    ...
    url = new Url("hTTp://starfish:123@mirror1.NEWs.sina.com.cn:80/"
        + "///tt/./../../../../2010/06/01/current.html?id=123#top");
    assertEquals(false, url.isEmpty());
    assertEquals("http://starfish:123@mirror1.news.sina.com.cn/2010/06/01/current.html?id=123#top",
        url.toString());
