...
public interface CharList extends CharCollection {
  ...
  /**
   * Returns {@code true} iff <i>that</i> is an {@code CharList} that contains
   * the same elements in the same order as me.
   *
   * <p>In other words, returns {@code true} iff <i>that</i> is a
   * {@code CharList} that has the same {@link #size() size} as me, and for
   * which the elements returned by its {@link CharList#iterator iterator} are
   ...
   * the {@code CharList} interface.)
   *
   * @param that
   *     the object to compare to me.
   * @return {@code true} iff <i>that</i> is an {@code CharList} that contains
   *     the same elements in the same order as me.
   */
  @Override
   ...
   *
   * <p>The hash code of an {@code CharList} is defined to be the result of
  ...
  /**
   * Returns an {@link CharIterator iterator} over all elements, in the
   * appropriate sequence.
   *
   * @return an {@link CharIterator iterator} over all elements.
   */
  @Override
  ...
  /**
   * Returns a {@link CharListIterator bidirectional iterator} over all
   * elements, in the appropriate sequence.
   *
   * @return an {@link CharListIterator iterator} over all elements.
   */
   ...
   * @param index
   *     the specified index.
   * @return the specified {@link CharListIterator iterator}.
   * @throws IndexOutOfBoundsException
   *     if the specified index is out of range.
   */
   ...
   *
   * <p>The returned {@code CharList} is backed by me, so that any changes in
   ...
   * <code><i>fromIndex</i> == 0 &amp;&amp;<i>toIndex</i> == {@link #size()
   * size()}</code> the returned list is my "improper" sublist, containing all
   * my elements.
   *
