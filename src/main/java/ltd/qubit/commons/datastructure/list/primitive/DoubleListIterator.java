...
public interface DoubleListIterator extends DoubleIterator {
   ...
   * direction. (In other words, returns {@code true} iff a call to {@link
   * #next} will return an element rather than throwing an exception.
   *
   ...
   * direction. (In other words, returns {@code true} iff a call to {@link
   * #previous} will return an element rather than throwing an exception.
   *
