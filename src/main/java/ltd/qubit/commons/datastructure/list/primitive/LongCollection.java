...
public interface LongCollection extends Comparable<LongCollection>,
   ...
   * (optional operation).
   *
   * <p>The behavior of this method is unspecified if the given collection is
   * modified while this method is executing. Note that this includes the case
   * in which the given collection is this collection, and it is not empty.
   *
   * @param c
   ...
   *
   * <p>In other words, retains <i>only</i> my elements that are contained in
   * the specified collection.) The behavior of this method is unspecified if
   * the given collection is modified while this method is executing.
   *
   * @param c
