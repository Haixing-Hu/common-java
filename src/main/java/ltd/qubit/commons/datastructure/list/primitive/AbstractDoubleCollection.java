...
public abstract class AbstractDoubleCollection implements DoubleCollection {
  ...
  @Serial
  private static final long serialVersionUID = 2536959611978944777L;
  ...
  @Override
  public abstract boolean add(double element);
  ...
  public int compareTo(@Nullable final DoubleCollection other) {
    ...
    final DoubleIterator lhsIter = iterator();
