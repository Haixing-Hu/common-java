...
public interface FloatList extends FloatCollection {
  ...
  /**
   * Returns {@code true} iff <i>that</i> is an {@code FloatList} that contains
   * the same elements in the same order as me. In other words, returns {@code
   * true} iff <i>that</i> is a {@code FloatList} that has the same {@link
   * #size() size} as me, and for which the elements returned by its {@link
   * FloatList#iterator iterator} are equal ({@code ==}) to the corresponding
   * elements within me. (This contract ensures that this method works properly
   * across different implementations of the {@code FloatList} interface.)
   *
   * @param that
   *     the object to compare to me
   * @return {@code true} iff <i>that</i> is an {@code FloatList} that contains
   ...
   *
   * <p>The hash code of an {@code FloatList} is defined to be the result of the
  ...
  /**
   * Returns an {@link FloatIterator iterator} over all elements, in the
   * appropriate sequence.
   *
   * @return an {@link FloatIterator iterator} over all elements.
   */
  @Override
   ...
   *
   * @return an {@link FloatListIterator iterator} over all elements.
   */
   ...
   * @param index
   *     the specified index.
   * @return the specified {@link FloatListIterator iterator}.
   * @throws IndexOutOfBoundsException
   *     if the specified index is out of range
   */
   ...
   * {@code FloatList} is backed by me, so that any changes in the returned list
