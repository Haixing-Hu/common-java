...
public interface DoubleList extends DoubleCollection {
   ...
   * collection's {@link #iterator}.
   *
   * @param index
   *     the index at which to insert the first element from the specified
   *     collection
   * @param collection
   *     the {@link DoubleCollection} of elements to add.
   * @return {@code true} iff I changed as a result of this call.
   * @throws UnsupportedOperationException
   *     when this operation is not supported.
   * @throws IndexOutOfBoundsException
  ...
  /**
   * Returns {@code true} iff <i>that</i> is an {@code DoubleList} that contains
   * the same elements in the same order as me.
   *
   * <p>In other words, returns {@code true} iff <i>that</i> is a
   * {@code DoubleList} that has the same {@link #size()} as me, and for which
   * the elements returned by its {@link #iterator} are equal ({@code ==}) to
   * the corresponding elements within me.
   *
   * <p>This contract ensures that this method works properly across different
   * implementations of the {@code DoubleList} interface.
   *
   * @param that
   *     the object to compare to me.
   * @return {@code true} iff <i>that</i> is an {@code DoubleList} that contains
   *     the same elements in the same order as me.
   */
  @Override
   ...
   *
   * <p>The hash code of an {@code DoubleList} is defined to be the result of
  ...
  /**
   * Returns an {@link DoubleIterator iterator} over all elements, in the
   * appropriate sequence.
   *
   * @return an {@link DoubleIterator iterator} over all elements.
   */
  @Override
   ...
   *
   * @return an {@link DoubleListIterator iterator} over all elements.
   */
   ...
   * @param index
   *     the specified index.
   * @return the specified {@link DoubleListIterator iterator}.
   * @throws IndexOutOfBoundsException
   *     if the specified index is out of range
   */
   ...
   *
   * <p>The returned {@code DoubleList} is backed by me, so that any changes in
