...
public class InvalidXmlChildrenCountException extends XmlException {
  ...
  public InvalidXmlChildrenCountException(final String parentName,
      @Nullable final String childName, final int expectedMin,
      final int expectedMax, final int actual) {
  ...
  public InvalidXmlChildrenCountException(final String parentName,
      @Nullable final String childName, final int expectedMin,
      final int expectedMax, final int actual, final String message) {
  ...
  public static String formatMessage(final String parentName,
      final String childName, final int expectedMin, final int expectedMax,
      final int actual) {
