...
import ltd.qubit.commons.text.jackson.MapDeserializers;
import ltd.qubit.commons.text.jackson.MapKeyDeserializers;
import ltd.qubit.commons.text.jackson.MapSerializers;
...
public class TypeRegistrationModule extends com.fasterxml.jackson.databind.Module {
   ...
   * <p>
   * 这些类型注册器是定义在此JAR的
   * {@code META-INF/services/ltd.qubit.commons.text.jackson.module.type.TypeRegister}
   * 中的。
   */
  @SuppressWarnings("rawtypes")
