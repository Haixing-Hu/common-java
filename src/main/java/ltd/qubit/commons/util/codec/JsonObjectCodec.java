 ...
 */
public class JsonObjectCodec<T> implements ObjectCodec<T> {

  private final JsonMapper mapper;
  private final Class<T> type;

  public JsonObjectCodec(final Class<T> type) {
    this(type, new CustomizedJsonMapper());
  }

  public JsonObjectCodec(final Class<T> type, final JsonMapper mapper) {
    this.mapper = mapper;
    this.type = type;
  }
