...
import ltd.qubit.commons.sql.error.NoDataSourceException;
...
public final class JdbcTemplate {
  ...
  /**
   * Retrieves whether the {@link Connection} objects generated by this {@link
   * JdbcTemplate} object are in read-only mode.
   *
   ...
   *
   * @return one of the following Connection constants: Connection.TRANSACTION_READ_UNCOMMITTED,
   *     Connection.TRANSACTION_READ_COMMITTED, Connection.TRANSACTION_REPEATABLE_READ,
   *     or Connection.TRANSACTION_SERIALIZABLE. (Note that
   ...
   *     a connection object.
   * @param sql
   *     a String object that is the SQL statement to be sent to the database;
   ...
   *     {@link JdbcOperation#perform(Connection)} function.
   * @param operation
